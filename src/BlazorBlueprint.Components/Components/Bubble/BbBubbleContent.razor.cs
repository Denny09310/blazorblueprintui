...
public partial class BbBubbleContent : ComponentBase
{
    ...
    private string CssClass => ClassNames.cn(
        "bb:w-fit bb:max-w-full bb:min-w-0 bb:overflow-hidden bb:rounded-3xl bb:border bb:border-transparent bb:px-3 bb:py-2.5 bb:text-sm bb:leading-relaxed bb:wrap-break-word bb:group-data-[align=end]/bubble:self-end bb:[button]:text-start bb:[button,a]:transition-colors bb:[button,a]:outline-none bb:[button,a]:focus-visible:border-ring bb:[button,a]:focus-visible:ring-3 bb:[button,a]:focus-visible:ring-ring/30 bb:group-data-[variant=ghost]/bubble:border-0",
        Class
    );
}
