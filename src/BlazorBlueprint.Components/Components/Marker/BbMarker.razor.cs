...
public partial class BbMarker : ComponentBase
{
    ...
    private string CssClass => ClassNames.cn(
        ...
        "bb:group/marker bb:relative bb:flex bb:min-h-4 bb:w-full bb:items-center bb:gap-2 bb:text-start bb:text-sm bb:text-muted-foreground bb:[&_svg:not([class*='size-'])]:size-4 bb:[a]:underline bb:[a]:underline-offset-3 bb:[a]:hover:text-foreground",
        Variant switch
        {
        ...
        Variant == MarkerVariant.Separator
            ? "bb:before:me-1 bb:before:h-px bb:before:min-w-0 bb:before:flex-1 bb:before:bg-border bb:after:ms-1 bb:after:h-px bb:after:min-w-0 bb:after:flex-1 bb:after:bg-border"
            : null,
        Class
    );
}
