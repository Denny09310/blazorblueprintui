...
/// directive sits. An element written as <c>style="@Merged" @attributes="AdditionalAttributes"</c>
/// therefore computes the merge and then throws it away: the consumer's raw <c>style</c> arrives
/// second and replaces it. Splatting <see cref="WithoutStyle"/> instead keeps the merged value.
/// </para>
/// <para>
/// <see cref="BbPrimitiveBase"/> exposes the same two operations as instance members for components
/// that inherit it; this is the shared implementation, for the ones that do not.
/// </para>
/// </summary>
